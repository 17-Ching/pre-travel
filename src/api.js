...
export async function loadAll() {
  const [profiles, trips, members, regions, tags, items, itemTags, invites] = await Promise.all([
  ...
  for (const r of [profiles, trips, members, regions, tags, items, itemTags, invites]) {
